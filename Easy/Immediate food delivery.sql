...
**Query #1**
    ...
    select round((select * from t1)/(select * from t2) * 100, 2)  as immediate_percentage from dual;
...
[View on DB Fiddle](https://www.db-fiddle.com/f/3D16UdZtKYrskioqhBLiGW/1)